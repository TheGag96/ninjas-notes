...
\begin{itemize}
  ...
  \item automatic copy is made when C++ auto generated copy constructor is called since the copy construcor for \cpp{CBPtr} is called
